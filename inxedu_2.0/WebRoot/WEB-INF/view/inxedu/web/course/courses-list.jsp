				...
				<div class="js-wrap">
					...
					<section class="fl">
						<ol class="js-tap clearfix">
							...
							<li <c:if test="${queryCourse.order=='PRICE'}">class="current bg-orange"</c:if>><a title="价格" onclick="submitForm(3,'PRICE')" href="javascript:void(0)">价格</a></li>
						</ol>
					</section>
				</div>
				<div class="mt40">
									...
									<li>
										<div class="cc-l-wrap">
											...
											<section class="mt10 hLh20 of">
												...
												<%-- <span class="fr jgTag bg-green"> <c:if test="${course.currentPrice<=0 }">
														<tt class="c-fff fsize12 f-fA">免费</tt>
													</c:if> <c:if test="${course.currentPrice>0 }">
														<tt class="c-fff fsize14 f-fG">￥${course.currentPrice }</tt>
													</c:if>

												</span>  --%><span class="fl jgAttr c-ccc f-fA"> <tt class="c-999 f-fA">${course.pageBuycount }人学习</tt> | <tt class="c-999 f-fA">${course.pageViewcount }浏览</tt>
												</span>
											</section>
										</div>
									</li>
