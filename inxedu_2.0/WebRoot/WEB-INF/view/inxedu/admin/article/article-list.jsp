	...
	<div class="pad20">
		<form action="${ctx}/admin/article/showlist" method="post" id="searchForm">
			...
			<input placeholder="开始创建时间" name="queryArticle.beginCreateTime"
				value="<fmt:formatDate value="${queryArticle.beginCreateTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" id="beginCreateTime" type="text"
				readonly="readonly" style="width: 128px;"/>-
			<input placeholder="结束创建时间" id="endCreateTime" name="queryArticle.endCreateTime"
				value="<fmt:formatDate value="${queryArticle.endCreateTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" type="text" readonly="readonly" style="width: 128px;"/>
