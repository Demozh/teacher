		...
		<form action="${ctx}/admin/article/updatearticle" method="post" id="articleForm" data-validator-option="{stopOnError:false, timely:false}">
			...
			<table style="line-height: 35px;">
				...
				<tr>
					<td>发布时间：</td>
					<td>
						<input name="article.publishTime" data-rule="required;" id="publishTime" readonly="readonly" type="text" style="width: 140px;" value="<fmt:formatDate value="${article.publishTime}" pattern="yyyy-MM-dd HH:mm"/>" />
					</td>
				</tr>
				<tr>
					<td>
